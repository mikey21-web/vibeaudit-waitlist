...
function StepVisual({ kind }: { kind: "scan" | "score" | "prompt" }) {
  if (kind === "scan") {
    return (
      <div className="overflow-hidden rounded-[10px] border border-line bg-surface transition-transform duration-500 hover:translate-y-[-2px]">
  ...
  if (kind === "score") {
    ...
    return (
      <div className="rounded-[10px] border border-line bg-surface p-6 transition-transform duration-500 hover:translate-y-[-2px]">
  ...
  return (
    <div className="rounded-[10px] border border-line bg-surface p-5 transition-transform duration-500 hover:translate-y-[-2px]">
      ...
      <button className="btn-glow mt-4 inline-flex h-8 items-center rounded-[5px] border border-line bg-elevated px-3 text-[12px] font-medium text-ink-primary">
        Copy prompt
      </button>
    </div>
  )
